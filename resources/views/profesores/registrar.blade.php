...
@section('content_header')
    ...
    <form action= "{{url('profesores/registrar')}}" method= "POST" >
        ...
        <div class="mb-3">
            <label for="caategoriaProfesor" class="form-label">Categoria</label>
            <input type="text" class="form-control" id="categoriaProfesor" name="categoriaProfesor" placeholder="Ingrese la categoria (A,B,C)">
        </div>
